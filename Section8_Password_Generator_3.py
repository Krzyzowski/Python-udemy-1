...
uppercase = tk.Checkbutton(root, text="Include uppercase", variable=uppercase_var)
uppercase.pack()


lowercase_var = tk.BooleanVar(value=True)
lowercase = tk.Checkbutton(root, text="Include lowercase", variable=lowercase_var)
lowercase.pack()
